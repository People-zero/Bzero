...
const Community = () => {
    ...
    const getProcessedPostList = () => {
        ...
        const filterlist = filter === 1 ? copyList : copyList.filter((it)=>filters(it))
        ...
        <div className="Community">
            ...
            <div className="Community_body">
                <div className="Community_body_one">
                    ...
                    <div className="Community_body_one_post"><button className='Community_body_one_posts' onClick={()=>navigate('/post')}>글쓰기 
                        <img className='Community_body_one_post_imgs' src={process.env.PUBLIC_URL + `/icon/write.png`}/></button>
                    </div>
                </div>
                ...
                <div className="Community_body_three">
                    <div className='Community_body_three_mir'>
                        ...
                        <input className='Community_body_three_serch' type="text" placeholder='검색어를 입력하세요.' 
                    ...
                    <div className='Community_body_four_right'>
                        ...
                        <div  className='Community_body_four_postlist'>
                                {getProcessedPostList().map((it)=>(
                                    <div className='Community_body_four_postlist_s' onClick={()=>navigate(`/details/${it.id}`,
                                     { state: it })} key={it.id}>
                                        <span className='Community_body_four_postlist_ss'>
                                            <span className='Community_body_four_postlist_ss_title'>{it.title}</span>
                                            <br />
                                            <span className='Community_body_four_postlist_ss_content'>{it.content}</span>
                                        </span>
                                        
                                        <span className='Community_body_four_postlist_imgs'>
                                                <img className='Community_body_four_postlist_imgs1' src={process.env.PUBLIC_URL + `/icon/Good.png`}/>
                                                <div></div>
                                                <img className='Community_body_four_postlist_imgs2' src={process.env.PUBLIC_URL + `/icon/Pin.png`}/>
                                                <div></div>
                                        </span>
                                    </div>
                                ))}
